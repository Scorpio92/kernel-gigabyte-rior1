...
#define ECS_DATA_DEV_NAME	"eCompass"
#define ECS_CTRL_DEV_NAME	"ecompass_ctrl"

#define VENDOR_NAME		"MEMSIC"
#define SENSOR_NAME		"mmc328x"
...
#else
static DEVICE_ATTR(info, 0644, mmc328x_info_show, NULL);
#endif
...
static long ecs_ctrl_ioctl(struct file *file,
...
//		-32768*4, 32768*4, 0, 0);
	...
	if (res) {
	 ...
	 if(sysfs_create_group(&ecs_data_device->dev.kobj, &mmc328x_attr_group))
	 {
	 	pr_err("create mmc328x sys failed\n");
		goto out_deregister_misc;
	 }
