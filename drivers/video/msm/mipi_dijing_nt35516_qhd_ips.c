...
static int mipi_dijing_nt35516_qhd_ips_late_init(void)
{
	int ret;

#ifdef CONFIG_FB_MSM_MIPI_AUTO_DETECT
	if (msm_fb_detect_client("mipi_dijing_nt35516_qhd_pt"))
		return 0;
#endif
	...
	ret = mipi_nt35516_dijing_device_register(&pinfo, MIPI_DSI_PRIM,
...
static int __init mipi_dijing_nt35516_cmd_qhd_ips_init(void)
{
  mipi_dijing_nt35516_qhd_ips_late_init();
  return 0;
}

module_init(mipi_dijing_nt35516_cmd_qhd_ips_init);
