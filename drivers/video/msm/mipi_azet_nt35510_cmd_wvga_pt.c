...
static int __init mipi_cmd_nt35510_wvga_pt_init(void)
{
	...
	if (msm_fb_detect_client("mipi_azet_nt35510"))
		return 0;
#endif
#if 1
	pinfo.xres = 480;
...
pinfo.mipi.dst_format = DSI_VIDEO_DST_FORMAT_RGB888;
	...
	ret = mipi_nt35510_azet_device_register(&pinfo, MIPI_DSI_PRIM,
...
static int mipi_cmd_azet_td_t400t1g4003_wvga_pt_init(void)
{
	int ret;
...
module_init(mipi_cmd_azet_td_t400t1g4003_wvga_pt_init);
#endif
