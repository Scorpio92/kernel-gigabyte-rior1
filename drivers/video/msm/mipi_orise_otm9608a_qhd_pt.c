...
#if 0
	 {0x3A,0x20,0x05,0x00, 0x25,0x2F,0x09,0x23,      // add 150M
         0x06,0x03,0x04},
#endif
	/* phy ctrl */
	{0x7f, 0x00, 0x00, 0x00},
...
static int mipi_cmd_otm9608a_qhd_pt_late_init(void)
{
	...
	if (msm_fb_detect_client("mipi_orise_otm9608a_qhd_pt"))
		return 0;
#endif
	...
	ret = mipi_king_otm9608a_device_register(&pinfo, MIPI_DSI_PRIM,
