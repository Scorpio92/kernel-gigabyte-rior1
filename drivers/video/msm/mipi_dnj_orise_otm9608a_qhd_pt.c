...
static int mipi_cmd_otm9608a_qhd_pt_late_init(void)
{
	int ret;

#ifdef CONFIG_FB_MSM_MIPI_AUTO_DETECT
	if (msm_fb_detect_client("mipi_dnj_orise_otm9608a_qhd_pt"))
		return 0;
#endif
	...
	pinfo.lcd.refx100 = 7000; /* adjust refx100 to prevent tearing  ORIGIN 6000 */
	...
	ret = mipi_dnj_otm9608a_device_register(&pinfo, MIPI_DSI_PRIM,
...
static int __init mipi_otm9608a_cmd_qhd_pt_init(void)
{
  mipi_cmd_otm9608a_qhd_pt_late_init();
  return 0;
}

module_init(mipi_otm9608a_cmd_qhd_pt_init);
