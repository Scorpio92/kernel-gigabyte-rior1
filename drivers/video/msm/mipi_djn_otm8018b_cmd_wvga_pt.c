...
static int mipi_truly_djn8018b_qhd_ips_late_init(void)
{
	int ret;
...
static int __init mipi_djn8018b_cmd_qhd_ips_init(void)
{
  mipi_truly_djn8018b_qhd_ips_late_init();
  return 0;
}

module_init(mipi_djn8018b_cmd_qhd_ips_init);
