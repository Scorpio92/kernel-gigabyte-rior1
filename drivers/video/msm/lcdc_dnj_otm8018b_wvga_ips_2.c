...
static __inline void otm_lcd_panel_init(void)
{
	...
	msleep(150);
		...
		WriteREG_command(0xF5,0x80); WriteREG_para(0x01);
		WriteREG_command(0xF5,0x81); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x82); WriteREG_para(0x02);
		WriteREG_command(0xF5,0x83); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x84); WriteREG_para(0x10);
		WriteREG_command(0xF5,0x85); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x86); WriteREG_para(0x02);
		WriteREG_command(0xF5,0x87); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x88); WriteREG_para(0x0E);
		WriteREG_command(0xF5,0x89); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x8A); WriteREG_para(0x0F);
		WriteREG_command(0xF5,0x8B); WriteREG_para(0x20);

		WriteREG_command(0xF5,0x90); WriteREG_para(0x02);
		WriteREG_command(0xF5,0x91); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x92); WriteREG_para(0x08);
		WriteREG_command(0xF5,0x93); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x94); WriteREG_para(0x06);
		WriteREG_command(0xF5,0x95); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x96); WriteREG_para(0x0D);
		WriteREG_command(0xF5,0x97); WriteREG_para(0x18);
		WriteREG_command(0xF5,0x98); WriteREG_para(0x0B);
		WriteREG_command(0xF5,0x99); WriteREG_para(0x18);

		WriteREG_command(0xF5,0xA0); WriteREG_para(0x10);
		WriteREG_command(0xF5,0xA1); WriteREG_para(0x18);
		WriteREG_command(0xF5,0xA2); WriteREG_para(0x01);
		WriteREG_command(0xF5,0xA3); WriteREG_para(0x18);
		WriteREG_command(0xF5,0xA4); WriteREG_para(0x14);
		WriteREG_command(0xF5,0xA5); WriteREG_para(0x18);
		WriteREG_command(0xF5,0xA6); WriteREG_para(0x14);
		WriteREG_command(0xF5,0xA7); WriteREG_para(0x18);

		WriteREG_command(0xF5,0xB0); WriteREG_para(0x14);
		WriteREG_command(0xF5,0xB1); WriteREG_para(0x18);
		WriteREG_command(0xF5,0xB2); WriteREG_para(0x12);
		WriteREG_command(0xF5,0xB3); WriteREG_para(0x18);
		WriteREG_command(0xF5,0xB4); WriteREG_para(0x13);
		WriteREG_command(0xF5,0xB5); WriteREG_para(0x18);
		WriteREG_command(0xF5,0xB6); WriteREG_para(0x11);
		WriteREG_command(0xF5,0xB7); WriteREG_para(0x18);
		WriteREG_command(0xF5,0xB8); WriteREG_para(0x13);
		WriteREG_command(0xF5,0xB9); WriteREG_para(0x18);
		WriteREG_command(0xF5,0xBA); WriteREG_para(0x00);
		WriteREG_command(0xF5,0xBB); WriteREG_para(0x00);

		WriteREG_command(0xC0,0xB4); WriteREG_para(0x10);/////////////////

		WriteREG_command(0xC5,0x82); WriteREG_para(0xA3);

		WriteREG_command(0xC5,0x90); WriteREG_para(0x96);
		WriteREG_command(0xC5,0x91); WriteREG_para(0x76);

		WriteREG_command(0xD8,0x00); WriteREG_para(0x7F);
		WriteREG_command(0xD8,0x01); WriteREG_para(0x7F);

		WriteREG_command(0xD9,0x00); WriteREG_para(0x67);///72  6a

		WriteREG_command(0xC1,0x81); WriteREG_para(0x66);

		WriteREG_command(0xC1,0xA1); WriteREG_para(0x08);

		WriteREG_command(0xC0,0xA3); WriteREG_para(0x1B);

		WriteREG_command(0xC4,0x81); WriteREG_para(0x83);
		...
		WriteREG_command(0xC1,0xA0); WriteREG_para(0xEA);

		WriteREG_command(0xC1,0xA6); WriteREG_para(0x01);
		...
		WriteREG_command(0xCE,0x90); WriteREG_para(0x33);
		WriteREG_command(0xCE,0x91); WriteREG_para(0x26);
		WriteREG_command(0xCE,0x92); WriteREG_para(0x00);
		WriteREG_command(0xCE,0x93); WriteREG_para(0x33);
		WriteREG_command(0xCE,0x94); WriteREG_para(0x27);
		WriteREG_command(0xCE,0x95); WriteREG_para(0x00);

		WriteREG_command(0xCE,0xA0); WriteREG_para(0x38);
		WriteREG_command(0xCE,0xA1); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xA2); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xA3); WriteREG_para(0x20);
		...
		WriteREG_command(0xCE,0xA8); WriteREG_para(0x02);
		WriteREG_command(0xCE,0xA9); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xAA); WriteREG_para(0x21);
		...
		WriteREG_command(0xCE,0xB1); WriteREG_para(0x01);
		WriteREG_command(0xCE,0xB2); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xB3); WriteREG_para(0x22);
		...
		WriteREG_command(0xCE,0xB7); WriteREG_para(0x38);
		WriteREG_command(0xCE,0xB8); WriteREG_para(0x00);
		WriteREG_command(0xCE,0xB9); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xBA); WriteREG_para(0x23);
		...
		WriteREG_command(0xCE,0xC1); WriteREG_para(0x00);
		WriteREG_command(0xCE,0xC2); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xC3); WriteREG_para(0x24);
		...
		WriteREG_command(0xCE,0xC8); WriteREG_para(0x01);
		WriteREG_command(0xCE,0xC9); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xCA); WriteREG_para(0x25);
		...
		WriteREG_command(0xCE,0xD1); WriteREG_para(0x02);
		WriteREG_command(0xCE,0xD2); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xD3); WriteREG_para(0x26);
		...
		WriteREG_command(0xCE,0xD8); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xD9); WriteREG_para(0x03);
		WriteREG_command(0xCE,0xDA); WriteREG_para(0x27);
		...
		WriteREG_command(0xCB,0xC4); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xC5); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xC6); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xC7); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xC8); WriteREG_para(0x00);
		WriteREG_command(0xCB,0xC9); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xCA); WriteREG_para(0x00);
		WriteREG_command(0xCB,0xCB); WriteREG_para(0x54);
		...
		WriteREG_command(0xCB,0xD9); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xDA); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xDB); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xDC); WriteREG_para(0x54);
		WriteREG_command(0xCB,0xDD); WriteREG_para(0x00);
		WriteREG_command(0xCB,0xDE); WriteREG_para(0x54);

		WriteREG_command(0xCB,0xE0); WriteREG_para(0x00);
		WriteREG_command(0xCB,0xE1); WriteREG_para(0x54);
		...
		WriteREG_command(0xCC,0x89); WriteREG_para(0x02);

		WriteREG_command(0xCC,0x90); WriteREG_para(0x00);
		WriteREG_command(0xCC,0x91); WriteREG_para(0x06);
		...
		WriteREG_command(0xCC,0xA4); WriteREG_para(0x01);
		WriteREG_command(0xCC,0xA5); WriteREG_para(0x00);
		WriteREG_command(0xCC,0xA6); WriteREG_para(0x05);
		...
		WriteREG_command(0xCC,0xB9); WriteREG_para(0x05);

		WriteREG_command(0xCC,0xC0); WriteREG_para(0x00);
		WriteREG_command(0xCC,0xC1); WriteREG_para(0x01);
		...
		WriteREG_command(0xCC,0xD4); WriteREG_para(0x06);
		WriteREG_command(0xCC,0xD5); WriteREG_para(0x00);
		WriteREG_command(0xCC,0xD6); WriteREG_para(0x02);
		...
		WriteREG_command(0xE1,0x01); WriteREG_para(0x07);
		WriteREG_command(0xE1,0x02); WriteREG_para(0x0C);
		WriteREG_command(0xE1,0x03); WriteREG_para(0x0D);
		WriteREG_command(0xE1,0x04); WriteREG_para(0x06);
		WriteREG_command(0xE1,0x05); WriteREG_para(0x0E);
		WriteREG_command(0xE1,0x06); WriteREG_para(0x0B);
		WriteREG_command(0xE1,0x07); WriteREG_para(0x0A);
		WriteREG_command(0xE1,0x08); WriteREG_para(0x03);
		WriteREG_command(0xE1,0x09); WriteREG_para(0x07);
		WriteREG_command(0xE1,0x0A); WriteREG_para(0x0C);
		WriteREG_command(0xE1,0x0B); WriteREG_para(0x08);
		WriteREG_command(0xE1,0x0C); WriteREG_para(0x0F);
		WriteREG_command(0xE1,0x0D); WriteREG_para(0x12);
		WriteREG_command(0xE1,0x0E); WriteREG_para(0x0D);
		WriteREG_command(0xE1,0x0F); WriteREG_para(0x06);

		WriteREG_command(0xE2,0x00); WriteREG_para(0x00);
		WriteREG_command(0xE2,0x01); WriteREG_para(0x07);
		WriteREG_command(0xE2,0x02); WriteREG_para(0x0C);
		WriteREG_command(0xE2,0x03); WriteREG_para(0x0D);
		WriteREG_command(0xE2,0x04); WriteREG_para(0x06);
		WriteREG_command(0xE2,0x05); WriteREG_para(0x0E);
		WriteREG_command(0xE2,0x06); WriteREG_para(0x0B);
		WriteREG_command(0xE2,0x07); WriteREG_para(0x0A);
		WriteREG_command(0xE2,0x08); WriteREG_para(0x03);
		WriteREG_command(0xE2,0x09); WriteREG_para(0x07);
		WriteREG_command(0xE2,0x0A); WriteREG_para(0x0C);
		WriteREG_command(0xE2,0x0B); WriteREG_para(0x08);
		WriteREG_command(0xE2,0x0C); WriteREG_para(0x0F);
		WriteREG_command(0xE2,0x0D); WriteREG_para(0x12);
		WriteREG_command(0xE2,0x0E); WriteREG_para(0x0D);
		WriteREG_command(0xE2,0x0F); WriteREG_para(0x06);
...
static int __init lcdc_dijing_panel_ips_2_init(void)
{
	...
	if (msm_fb_detect_client("lcdc_dnj_otm8018b_wvga_ips_2")) {
		return 0;
	}
#endif	
...
device_initcall(lcdc_dijing_panel_ips_2_init);
